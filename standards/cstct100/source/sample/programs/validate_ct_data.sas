...
proc sql;
  ...
  values("&_cstStandard"  "&_cstStandardVersion"  "results"           "validationresults"  "results"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/results"  . "validation_results_&_cstCTStandard._&_cstCTDate"    "")
  values("&_cstStandard"  "&_cstStandardVersion"  "results"           "validationmetrics"  "results"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/results"  . "validation_metrics_&_cstCTStandard._&_cstCTDate"    "")
