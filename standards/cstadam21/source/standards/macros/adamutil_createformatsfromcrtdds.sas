...
%*                                                                                *;
%* This macro derives code lists from a CRT-DDS data library that is derived from *;
%* the define.xml file for a CDISC ADAM study.                                    *;
%*                                                                                *;
...
%*    3. The following macro variables must be set either before invoking this    *;
...
%*    4. The following macro variables must be set before invoking this macro:    *;
...
%macro adamutil_createformatsfromcrtdds(
...
%mend adamutil_createformatsfromcrtdds;