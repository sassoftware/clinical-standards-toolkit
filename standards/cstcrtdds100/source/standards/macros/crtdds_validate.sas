...
%* crtdds_validate                                                                *;
%*                                                                                *;
%* Validates CDISC CRT-DDS model files.                                           *;
%*                                                                                *;
%* This macro cycles through the validation checks to be run, writing validation  *;
%* results to the process Results and Metrics data sets. These data sets are      *;
%* persisted to any permanent location based on type=results records in a         *;
...
%* @macvar _cstTableMetadata Data set containing table-level metadata supporting  *;
%*             validation                                                         *;
%* @macvar _cstColumnMetadata Data set containing column-level metadata           *;
...
%macro crtdds_validate(_cstCallingPgm=Unspecified
    ) / des='CST: Validate CDISC CRTDDS model files';
      ...
      data work.&_cstThisCheckDS (label="Current check single obs DS" drop=_cstCheckMacroName _cstResultSeq _cstStatusText);
        ...
        do;
          ...
          do;
            ...
            put @10 ",_cstResultSeqParm=&_cstResultSeq,_cstSrcDataParm=CRTDDS_VALIDATE";
