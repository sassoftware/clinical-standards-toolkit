...
%*                                                                                *;
%* This macro is ADaM-specific in the way that it creates the Mandatory column,   *;
%* which is always 'No' for AdaM.                                                 *;
%*                                                                                *;
...
%macro crtdds_itemgroupdefitemrefs_adam(
    _cstsourcecolumns=,
    _cstsourcetables=,
    _cstsourcestudy=,
    _cstitemdefsds2=,
...
%mend crtdds_itemgroupdefitemrefs_adam;
