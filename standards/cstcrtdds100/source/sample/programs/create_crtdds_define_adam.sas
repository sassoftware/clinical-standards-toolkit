...
proc sql;
  ...
  values ("&_cstStandard"  "&_cstStandardVersion"  "results"      "results"    "results"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/results"   . "write_results_adam.sas7bdat" "")
  values ("&_cstStandard"  "&_cstStandardVersion"  "sourcedata"   ""           "srcdata"  "libref"  "input"  "folder"   "N"  "" "&studyRootPath/adamdata"    . ""                            "")
  values ("&_cstStandard"  "&_cstStandardVersion"  "externalxml"  "xml"        "extxml"   "fileref" "output" "file"     "Y"  "" "&studyOutputPath/sourcexml" . "define_adam.xml"             "")
  values ("&_cstStandard"  "&_cstStandardVersion"  "referencexml" "stylesheet" "xslt01"   "fileref" "input"  "file"     "Y"  "" ""                           . "define-v1-updated-html.xsl"  "")
...
proc xsl 
  in=extxml 
  xsl=xslt01 
  out="&studyOutputPath/sourcexml/define_adam.html"; 
run; 
