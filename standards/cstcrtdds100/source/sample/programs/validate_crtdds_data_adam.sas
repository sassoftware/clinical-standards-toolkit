...
proc sql;
  ...
  values("&_cstStandard" "&_cstStandardVersion"  "template"          ""                   "crttmpl"  "libref"  "input"  "folder"   "N"  "" ""                          1 ""                        "")
  ...
  values("&_cstStandard" "&_cstStandardVersion"  "fmtsearch"         ""                   "crtfmt"   "libref"  "input"  "catalog"  "N"  "" ""                          1 ""                        "")
  ...
  values("&_cstStandard" "&_cstStandardVersion"  "results"           "validationresults"  "results"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/results"  . "validation_results_adam" "")
  values("&_cstStandard" "&_cstStandardVersion"  "results"           "validationmetrics"  "results"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/results"  . "validation_metrics_adam" "")
