...
proc sql;
  ...
  values ("&_cstStandard"  "&_cstStandardVersion"  "report"       "outputfile" "pdfrpt"   "fileref" "output" "file"     "Y" "" "&studyOutputPath/sourcexml" . "define.pdf"                 "")
  values ("&_cstStandard"  "&_cstStandardVersion"  "results"      "results"    "results"  "libref"  "output" "dataset"  "Y" ""  "&studyOutputPath/results"  . "write_results_pdf.sas7bdat" "")
...
%crtdds_writepdf(
    ...
    _cstReportTitle=define.pdf for Study ABC,
...
%*crtdds_writepdf(
    ...
    _cstReportOutput=&studyOutputPath/sourcexml/define_links.pdf,
    _cstReportStyle=Printer_DefineXML,
    _cstFontSize=10pt,
...
%*crtdds_writepdf(
    _cstCDISCStandard=SDTM,
    _cstSourceLib=srcdata,
    _cstReportOutput=&studyOutputPath/sourcexml/define_links_printer.pdf,
