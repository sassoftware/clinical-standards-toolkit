...
* creating the CRTDDS Version 1.x data sets from the SDTM 3.1.x model            *;
...
%let _cstTrgStandardVersion=3.1.3;   * <----- User sets to type of data being extracted  *;
...
proc sql;
  ...
  values ("&_cstStandard"     "&_cstStandardVersion"    "results"         "results"    "results"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/results"  .  "sdtmtodefine_results.sas7bdat" "")
  values ("&_cstStandard"     "&_cstStandardVersion"    "sourcedata"      ""           "srcdata"  "libref"  "output" "folder"   "Y"  "" "&studyOutputPath/data"     .  ""                      "")
  values ("&_cstTrgStandard"  "&_cstTrgStandardVersion" "fmtsearch"       ""           "srcfmt"   "libref"  "input"  "catalog"  "N"  "" "&studyRootPath/terminology/formats" 1 "formats.sas7bcat" "")
