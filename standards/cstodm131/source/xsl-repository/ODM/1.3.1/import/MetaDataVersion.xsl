...
<xsl:stylesheet version="1.0"
    ...
    <xsl:import href="ProtocolAliases.xsl" />
    ...
    <xsl:import href="MethodAliases.xsl" />
    ...
    <xsl:import href="ConditionAliases.xsl" />
    ...
    <xsl:for-each select="odm:MetaDataVersion">
      ...
      <xsl:call-template name="ProtocolAliases"/>
    ...
    <xsl:for-each select="odm:MetaDataVersion/odm:MethodDef/odm:Alias">
      <xsl:call-template name="MethodAliases"/>
    </xsl:for-each>
    ...
    <xsl:for-each select="odm:MetaDataVersion/odm:ConditionDef/odm:Alias">
      <xsl:call-template name="ConditionAliases"/>
    </xsl:for-each>
