...
<xsl:stylesheet version="1.0"
  ...
  <xsl:template match="/LIBRARY">
    ...
    <ODM xmlns="http://www.cdisc.org/ns/odm/v1.3">
      ...
      <xsl:attribute name="nciodm:Context"><xsl:value-of select="ODM/Context"/></xsl:attribute>
      <xsl:attribute name="nciodm:ControlledTerminologyVersion"><xsl:value-of select="ODM/ControlledTerminologyVersion"/></xsl:attribute>
