...
%let _cstStandardVersion=1.2.0;

%*let _cstCTStandard=adam;              * <------- Terminology standard *;
%*let _cstCTDate=202206;                * <------- Terminology date     *;

%*let _cstCTStandard=cdash;             * <------- Terminology standard *;
%*let _cstCTDate=202209;                * <------- Terminology date     *;

%*let _cstCTStandard=ddf;               * <------- Terminology standard *;
%*let _cstCTDate=202209;                * <------- Terminology date     *;

%*let _cstCTStandard=send;              * <------- Terminology standard *;
%*let _cstCTDate=202209;                * <------- Terminology date     *;

%*let _cstCTStandard=define;            * <------- Terminology standard *;
%*let _cstCTDate=202209;                * <------- Terminology date     *;
...
%cstutil_setcstsroot;
data _null_;
  call symput('studyRootPath',cats("&_cstSRoot","/cdisc-ct-1.2.0-&_cstVersion"));
  call symput('studyOutputPath',cats("&_cstSRoot","/cdisc-ct-1.2.0-&_cstVersion"));
run;
...
*        %cstutil_processsetup(_cstStandard=CDISC-CT)                                   *;
*****************************************************************************************;
...
proc sql;
  ...
  values("&_cstStandard"  "&_cstStandardVersion"  "template"          ""                   "cttmpl"   "libref"  "input"  "folder"   "N"  "" ""                          1 ""                      "")
  ...
  values("&_cstStandard"  "&_cstStandardVersion"  "fmtsearch"         ""                   "ctfmt"    "libref"  "input"  "catalog"  "N"  "" ""                          1 ""                      "")
  ...
  values("&_cstStandard"  "&_cstStandardVersion"  "results"           "validationresults"  "results"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/results"  . "validation_results_%substr(&_cstCTStandard,1,6)_&_cstCTDate"    "")
  values("&_cstStandard"  "&_cstStandardVersion"  "results"           "validationmetrics"  "results"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/results"  . "validation_metrics_%substr(&_cstCTStandard,1,6)_&_cstCTDate"    "")
