...
*                                                                                *;
* Sample driver program to read a ct xml 1.2.0 file                              *;
*                                                                                *;
* Assumptions:                                                                   *;
...
%*let _cstCTFile=ADaM Terminology.odm.xml;            * <------- Terminology file     *;

%*let _cstCTStandard=cdash;                           * <------- Terminology standard *;
%*let _cstCTDate=202209;                              * <------- Terminology date     *;
%*let _cstCTFile=CDASH Terminology.odm.xml;           * <------- Terminology file     *;

%*let _cstCTStandard=ddf;                             * <------- Terminology standard *;
%*let _cstCTDate=202209;                              * <------- Terminology date     *;
%*let _cstCTFile=DDF Terminology.odm.xml;             * <------- Terminology file     *;

%*let _cstCTStandard=send;                            * <------- Terminology standard *;
%*let _cstCTDate=202209;                              * <------- Terminology date     *;
%*let _cstCTFile=SEND Terminology.odm.xml;            * <------- Terminology file     *;

%*let _cstCTStandard=define;                          * <------- Terminology standard *;
%*let _cstCTDate=202209;                              * <------- Terminology date     *;
%*let _cstCTFile=Define-XML Terminology.odm.xml;      * <------- Terminology file     *;

%let _cstCTStandard=sdtm;                             * <------- Terminology standard *;
%let _cstCTDate=202209;                               * <------- Terminology date     *;
%let _cstCTFile=SDTM_Terminology.odm.xml;             * <------- Terminology file     *;
...
proc sql;
  ...
  values("&_cstStandard"  "&_cstStandardVersion"  "referencexml"      "map"        "ctmap"    "fileref" "input"  "file"     "N"  "" "&studyRootPath/referencexml"          1 "ct-1.2.0.map"  "")
