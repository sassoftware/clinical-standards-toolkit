...
* files for a CDISC-SDTM study.                                                  *;
*                                                                                *;
* The following source metadata files are used by Clinical Standards Toolkit to  *;
* support CDISC-SDTM validation and derivation of CDISC-CRTDDS (define.xml)      *;
* files:   source_tables                                                         *;
*          source_columns                                                        *;
*          source_study                                                          *;
*          source_documents                                                      *;
...
*  data:                                                                         *;
*    _cstSrcType=SDTMLIBRARY uses a single library of (presumably SDTM) SAS      *;
*       data sets.  The SDTM macro sdtmutil_createsrcmetafromsaslib is called.   *;
...
*       SDTM macro sdtmutil_createsrcmetafromcrtdds is called.                   *;
*                                                                                *;
...
%let _cstStandardVersion=3.1.3;    * <------- 3.1.1, 3.1.2, or 3.1.3   *;
%let _cstSrcType=SDTMLIBRARY;      * <------- SDTMLIBRARY or CRTDDS    *;
...
data _null_;
  ...
  select (_cstSource);
    when('SDTMLIBRARY')
    do;
      _cstTemp=cats('%sdtmutil_','createsrcmetafromsaslib');
      call symput('studyRootPath',cats("&_cstSRoot","/cdisc-sdtm-3.1.3-&_cstVersion/sascstdemodata"));
      call symput('studySrcDataPath',cats("&_cstSRoot","/cdisc-sdtm-3.1.3-&_cstVersion/sascstdemodata/data"));
      call symput('studyOutputPath',cats("&_cstSRoot","/cdisc-sdtm-3.1.3-&_cstVersion/sascstdemodata"));
    end;
    when('CRTDDS')
    do;
      _cstTemp=cats('%sdtmutil_','createsrcmetafromcrtdds');
...
************************************************************************************;
libname refmeta "&_cstGRoot/standards/cdisc-sdtm-3.1.3-&_cstVersion/metadata";
libname srcdata "&studySrcDataPath";
libname trgmeta "&studyOutputPath/derived/metadata";
options  mautosource sasautos=("&_cstGRoot/standards/cdisc-sdtm-3.1.3-&_cstVersion/macros", sasautos);
...
proc sql;
  ...
  values ("&_cstStandard" "&_cstStandardVersion"  "targetdata"        ""           "trgdata"  "libref"  "output" "folder"   "Y"  "" "&studyOutputPath/derived/data"      . ""                           "")
  values ("&_cstStandard" "&_cstStandardVersion"  "targetmetadata"    "study"      "trgmeta"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/derived/metadata"  . "source_study.sas7bdat"      "")
  values ("&_cstStandard" "&_cstStandardVersion"  "targetmetadata"    "document"   "trgmeta"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/derived/metadata"  . "source_documents.sas7bdat"  "")
  values ("&_cstStandard" "&_cstStandardVersion"  "targetmetadata"    "table"      "trgmeta"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/derived/metadata"  . "source_tables.sas7bdat"     "")
  values ("&_cstStandard" "&_cstStandardVersion"  "targetmetadata"    "column"     "trgmeta"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/derived/metadata"  . "source_columns.sas7bdat"    "")
  values ("&_cstStandard" "&_cstStandardVersion"  "targetmetadata"    "value"      "trgmeta"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/derived/metadata"  . "source_values.sas7bdat"     "")
  ;
quit;
...
%cstutil_getsasreference(_cstSASRefType=sourcedata,_cstSASRefsasref=_cstSDTMDataLib);
