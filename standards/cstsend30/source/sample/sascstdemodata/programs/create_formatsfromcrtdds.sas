...
* for a CDISC-SEND study as defined in the CRTDDS data (define.xml).             *;
*                                                                                *;
...
*  Assign SASAUTOS the cstGlobalLibrary (&_cstGRoot) where the standard specific (ie SEND30) macros reside   *;
