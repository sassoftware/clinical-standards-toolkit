...
%* @macvar _cstReflib SEND reference library                                      *;
%* @macvar _cstRefTableDS SEND reference table data set                           *;
%* @macvar _cstRefColumnDS SEND reference column data set                         *;
%* @macvar _cstSENDDataLib SEND metadata library                                  *;
...
%macro sendutil_createsrcmetafromcrtdds(
    ) / des='CST: Create SEND metadata from CRTDDS Data';
  ...
  proc sql noprint;
    ...
    select ds14.*, ds23.* from
      (select ds1.oid,
              upcase("&_cstSENDDataLib") as sasref1,
              case
  ...
  * Clear the filename;
  ...
  proc sql;
    ...
    select
      upcase("&_cstSENDDataLib") as sasref 'SAS metadata libref',
...
%mend sendutil_createsrcmetafromcrtdds;