...
* from the SAS representation of a Define-XML v2 file.                           *;
*                                                                                *;
* Assumptions:                                                                   *;
...
%let _cstTrgStandardVersion=3.1.2;   * <----- User sets to standard version *;
...
proc sql;
  ...
  values ("&_cstStandard"  "&_cstStandardVersion"  "sourcedata"   ""           "srcdata"  "libref"  "input"  "folder"   "N"  ""  "&studyRootPath/data/&_cstStandardSubFolder"  . ""               "")
