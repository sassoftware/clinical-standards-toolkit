...
%*                                                                                *;
%*    srcdata.CodeLists                                                           *;
%*    srcdata.EnumeratedItems                                                     *;
%*    srcdata.CodeListItems                                                       *;
%*    srcdata.ExternalCodeLists                                                   *;
%*    srcdata.TranslatedText[parent="CodeListItems"]                              *;
%*    srcdata.Aliases[parent="CodeLists"]                                         *;
%*    srcdata.Aliases[parent="EnumeratedItems"]                                   *;
%*    srcdata.Aliases[parent="CodeListItems"]                                     *;
%*                                                                                *;
...
%macro define_sourcecodelists(
    ...
    %let _cstTables=CodeLists TranslatedText EnumeratedItems CodeListItems TranslatedText ExternalCodeLists Aliases Aliases Aliases Aliases;
    %let _cstTabs=cl cl_tt clen clci clit_tt clext cl_al1 cl_al2 clen_al clci_al cl0 cl1 cl2 _cstCodeListRefs _cstCodeListRefs2 _cstSourceCodeLists;
    ...
    proc sql;
      ...
      order by cl.CodeList, Rank, OrderNumber, CodedValue
      ;
      ...
      create table clit_tt_&_cstRandom
      as select
