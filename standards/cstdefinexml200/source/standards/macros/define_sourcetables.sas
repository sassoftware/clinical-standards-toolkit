...
%macro define_sourcetables(
    ...
    %let _cstTables=ItemGroupDefs CommentDefs TranslatedText TranslatedText Aliases Aliases ItemGroupLeaf ItemGroupLeafTitles;
    %let _cstTabs=igd igd_cm igd_des_tt igd_cm_tt igd_al1 igd_al2 igd_lf igd_lft _cstSourceTables;
    ...
    proc sql;
      ...
      as select
        ...
        tab.Class as Class,
        "LF."||kstrip(tab.Table) as ArchiveLocationID,
