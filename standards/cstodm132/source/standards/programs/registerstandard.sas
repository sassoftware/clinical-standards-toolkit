...
%let _thisStandard=CDISC-ODM;
%let _thisStandardVersion=1.3.2;
%let _thisProductRevision=1.7;
%let _thisDirWithinStandards=cdisc-odm-1.3.2-1.7;
  ...
  %if ((&_stdVersionIsRegistered=0) or
    ...
    * Register the standard to the global library;
    %cst_registerStandard(
      ...
      %cst_setStandardVersionDefault(_cstStandard=CDISC-ODM,_cstStandardVersion=1.3.2);
