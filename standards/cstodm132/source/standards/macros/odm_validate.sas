...
%macro odm_validate(_cstCallingPgm=Unspecified
    ) / des='CST: Validate CDISC ODM model files';
      ...
      data work.&_cstThisCheckDS (label="Current check single obs DS" drop=_cstCheckMacroName _cstResultSeq _cstStatusText);
        ...
        do;
          ...
          do;
            ...
            put @10 ",_cstResultSeqParm=&_cstResultSeq,_cstSrcDataParm=ODM_VALIDATE";
