...
<xsl:stylesheet version="1.0"
	...
	<xsl:template name="AuditRecord">
       ...
       <xsl:if test="count(../AuditRecord[ParentType = 'AuditRecords'][$parentType='ReferenceData']) != 0">
           <xsl:element name="AuditRecords">
               <xsl:for-each select="../AuditRecord[ParentType = 'AuditRecords'][GrandParentType = 'ReferenceData'][$parentType='ReferenceData']">
       ...
       <xsl:if test="count(../AuditRecord[ParentType = 'AuditRecords'][$parentType='ClinicalData']) != 0">
           <xsl:element name="AuditRecords">
               <xsl:for-each select="../AuditRecord[ParentType = 'AuditRecords'][GrandParentType = 'ClinicalData'][$parentType='ClinicalData']">
