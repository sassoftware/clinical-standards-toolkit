...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template name="Annotation">
        ...
        <xsl:if test="count(../Annotation[ParentType = 'Annotations'][$parentType='ReferenceData']) != 0">
            <xsl:element name="Annotations">
                <xsl:for-each select="../Annotation[ParentType = 'Annotations'][GrandParentType = 'ReferenceData'][$parentType='ReferenceData']">
        ...
        <xsl:if test="count(../Annotation[ParentType = 'Annotations'][$parentType='ClinicalData']) != 0">
            <xsl:element name="Annotations">
                <xsl:for-each select="../Annotation[ParentType = 'Annotations'][GrandParentType = 'ClinicalData'][$parentType='ClinicalData']">
                    <xsl:element name="Annotation">
