...
* extract all data set templates from an ODM XML file.                           *;
...
proc sql;
  ...
  values("&_cstTrgStandard" "&_cstTrgStandardVersion" "targetdata"       ""           "trgdata"  "libref"  "output" "folder"   "Y"  "" "&studyOutputPath/derived/templates" . ""                           "")
  values("&_cstStandard"    "&_cstStandardVersion"    "results"          "results"    "results"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/results"         . "extract_templates_results_all.sas7bdat" "")
