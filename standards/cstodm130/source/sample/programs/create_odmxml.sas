...
* create_odmxml.sas                                                              *;
*                                                                                *;
* Sample driver program to create an odm.xml file                                *;
*                                                                                *;
* Assumptions:                                                                   *;
...
proc sql;
  ...
  values ("&_cstStandard"  "&_cstStandardVersion"  "externalxml"  "xml"        "extxml"   "fileref" "output" "file"     "Y"  "" "&studyOutputPath/sourcexml"  . "odm_sample_out.xml"     "")
...
*******************************************************************************;
* Run the standard-specific ODM macros.                                       *;
*******************************************************************************;
