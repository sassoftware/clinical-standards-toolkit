...
*                                                                                *;
* extract_domaindata.sas                                                         *;
*                                                                                *;
* Sample driver program to perform a utility action specific to CDISC-ODM:       *;
* extract one or more data sets from the ClinicalData or ReferenceData sections  *;
...
proc sql;
  ...
  values("&_cstTrgStandard" "&_cstTrgStandardVersion" "targetdata"       ""           "trgdata"  "libref"  "output" "folder"   "Y"  ""  "&studyOutputPath/derived/domains" . "AE"                       "")
  values("&_cstStandard"    "&_cstStandardVersion"    "results"          "results"    "results"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/results"          . "extract_results.sas7bdat" "")
