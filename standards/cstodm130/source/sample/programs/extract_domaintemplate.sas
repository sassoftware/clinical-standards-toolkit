...
*                                                                                *;
* extract_domaintemplate.sas                                                     *;
*                                                                                *;
* Sample driver program to perform a utility action specific to CDISC-ODM:       *;
* extract one or more data set templates from an ODM XML file.                   *;
* However, this code assumes that the XML file has been converted into a SAS     *;
* representation of the ODM standard, such that this code runs against a set of  *;
* SAS data sets, NOT directly against the XML file.                              *;
*                                                                                *;
* Assumptions:                                                                   *;
...
%let _cstStandardVersion=1.3.0;      * <----- User sets to ODM version of interest       *;
...
proc sql;
  ...
  values("&_cstTrgStandard" "&_cstTrgStandardVersion" "targetdata"       ""           "trgdata"  "libref"  "output" "folder"   "Y"  ""  "&studyOutputPath/derived/templates" . "AE"                       "")
  values("&_cstStandard"    "&_cstStandardVersion"    "results"          "results"    "results"  "libref"  "output" "dataset"  "Y"  "" "&studyOutputPath/results"            . "extract_template_results.sas7bdat" "")
...
%odm_extractdomaindata(
  ...
  _cstSelectAttribute=SASDataSetName,
  _cstSelectAttributeValue=AE,
  _cstLang=,
  _cstMaxLabelLength=256,
  _cstAttachFormats=No,
  _cstOutputLibrary=,
  _cstOutputDS=,
  _cstOnlyTemplates=Yes
  );
...
%odm_extractdomaindata(
  _cstSourceMetaData=,
  _cstSourceData=,
  _cstIsReferenceData=Yes,
  _cstSelectAttribute=Name,
  _cstSelectAttributeValue=Lab normal ranges,
  _cstLang=,
  _cstMaxLabelLength=40,
  _cstAttachFormats=No,
  _cstOutputLibrary=,
  _cstOutputDS=normlab,
  _cstOnlyTemplates=Yes
  );
*/