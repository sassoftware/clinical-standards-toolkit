...
data _null_;
  ...
  select (_cstSource);
    ...
    do;
      ...
      call symput('studyRootPath',cats("&_cstSRoot","/cdisc-sdtm-3.2-&_cstVersion/sascstdemodata"));
      call symput('studySrcDataPath',cats("&_cstSRoot","/cdisc-sdtm-3.2-&_cstVersion/sascstdemodata/data"));
      call symput('studyOutputPath',cats("&_cstSRoot","/cdisc-sdtm-3.2-&_cstVersion/sascstdemodata"));
    end;
    when('CRTDDS')
    do;
...
************************************************************************************;
libname refmeta "&_cstGRoot/standards/cdisc-sdtm-3.2-&_cstVersion/metadata";
libname srcdata "&studySrcDataPath";
libname trgmeta "&studyOutputPath/derived/metadata";
options mautosource sasautos=("&_cstGRoot/standards/cdisc-sdtm-3.2-&_cstVersion/macros", sasautos);
...
proc sql;
  ...
  values ("&_cstStandard" "&_cstStandardVersion"  "targetdata"        ""           "trgdata"  "libref"  "output" "folder"   "N"  "" "&studyOutputPath/derived/data"      . ""                           "")
  ...
  values ("&_cstStandard" "&_cstStandardVersion"  "targetmetadata"    "document"   "trgmeta"  "libref"  "output" "dataset"  "N"  "" "&studyOutputPath/derived/metadata"  . "source_documents.sas7bdat"  "")
