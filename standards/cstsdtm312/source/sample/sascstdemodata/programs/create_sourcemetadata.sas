...
%let _cstStandardVersion=3.1.2;    * <------- 3.1.1 or 3.1.2           *;
...
data _null_;
  ...
  select (_cstSource);
    ...
    do;
      ...
      call symput('studyRootPath',cats("&_cstSRoot","/cdisc-sdtm-3.1.2-&_cstVersion/sascstdemodata"));
      call symput('studySrcDataPath',cats("&_cstSRoot","/cdisc-sdtm-3.1.2-&_cstVersion/sascstdemodata/data"));
      call symput('studyOutputPath',cats("&_cstSRoot","/cdisc-sdtm-3.1.2-&_cstVersion/sascstdemodata"));
    end;
    when('CRTDDS')
    do;
...
************************************************************************************;
libname refmeta "&_cstGRoot/standards/cdisc-sdtm-3.1.2-&_cstVersion/metadata";
libname srcdata "&studySrcDataPath";
libname trgmeta "&studyOutputPath/derived/metadata";
options  mautosource sasautos=("&_cstGRoot/standards/cdisc-sdtm-3.1.2-&_cstVersion/macros", sasautos);
