...
* for a CDISC-SDTM study as defined in the CRTDDS data (define.xml).             *;
*                                                                                *;
...
%let _cstStandardVersion=3.1.2;        * <------- 3.1.1, 3.1.2 or 3.1.3                    *;
...
*  Assign SASAUTOS the cstGlobalLibrary (&_cstGRoot) where the standard specific (ie SDTM312) macros reside  *;
...
**********************************************************************************************;
libname cstfmt  "&studyOutputPath/derived/formats";
...
proc sql;
  ...
  values ("&_cstStandard"     "&_cstStandardVersion"     "fmtsearch"      ""           "cstfmt"   "libref"  "output" "catalog"  "Y"  "" "&studyOutputPath/derived/formats" 1 "cterms.sas7bcat"           "")
  ;
quit;
